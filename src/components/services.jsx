    ...
    <div className="container px-5 py-12 mx-auto">
        ...
        <div className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                    <div className=" px-4 py-6 rounded-[20px] bg-[#F2D1D3] hover:bg-[#d68f93]">
                        <img src={img1} alt='serv-logo' className='w-[84px] h-[94px] mb-3 inline-block'/>
                ...
                <div className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                    <div className=" px-4 py-6 rounded-[20px] bg-[#F2D1D3] hover:bg-[#d68f93]  ">
                        <img src={img2} alt='serv-logo' className='w-[84px] h-[94px] mb-3 inline-block'/>
                ...
                <div className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                    <div className=" px-4 py-6 rounded-[20px] bg-[#F2D1D3] hover:bg-[#d68f93] ">
                        <img src={img4} alt='serv-logo' className='w-[84px] h-[94px] mb-3 inline-block'/>
